...
const pageData = {
  ...
  inquiryFields: [
    ...
    { id: "additional-request", label: "추가 요청사항", description: "색상 커스텀 관련 참고자료나 색상 코드가 있다면 함께 적어주세요.\n팬캐릭터 제작을 원하실 경우 위치를 알려주세요.\n요청사항이 없을 경우 생략하셔도 됩니다.", type: "textarea", placeholder: "추가 요청사항" },
  ...
  notices: [
    ...
    "고정형 배경의 경우 1회, 주문 제작의 경우 2회 무료 수정이 가능합니다.\n최종 작업물 전달 후 한달 이내로 수정을 요청해주세요. 기간 이후의 수정 및 추가 수정, 재작업이 필요한 수정의 경우 추가금이 발생합니다.",
